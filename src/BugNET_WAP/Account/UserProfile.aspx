        ...
        <asp:View ID="Notifications" runat="server">
          ...
          <div class="form-horizontal">
            ...
            <div class="form-group">
              <div class="col-md-5">
                <strong>
                  <asp:Literal ID="Literal5" runat="server" Text="[Resource Needed]" meta:resourceKey="AllProjects" /></strong>
              ...
              <div class="col-md-5">
                <strong>
                  <asp:Literal ID="Literal6" runat="server" Text="[Resource Needed]" meta:resourceKey="SelectedProjects" /></strong>
