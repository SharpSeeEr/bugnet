    ...
    <div class="row">
      ...
      <div class="col-sm-9">
        ...
        <div class="jumbotron" id="BlankSlate" visible="false" runat="server">
          ...
          <p>
            <a class="btn btn-primary btn-lg" href="http://bugnet.codeplex.com/documentation" role="button">
              <asp:Localize runat="server" ID="LearnMoreLocalize" meta:resourcekey="LearnMore" /></a>
          </p>
        </div>
        <br>
